...
public class ShoppingCart {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ShoppingCart().startApp());
    }
    ...
    private JPanel loginPanel() {
        ...
        loginBtn.addActionListener(e -> {
            ...
            if (users.containsKey(user) && users.get(user).equals(pass)) {
                currentUser = user;
                isAdmin = currentUser.equals("admin");
    ...
    private void addProduct() {
        ...
        String priceStr = JOptionPane.showInputDialog(frame, "Enter Product Price in ₹:");
    ...
    private void updateProduct() {
        ...
        for (Product p : products) {
            if (p.name.equals(productName)) {
                ...
                String newPriceStr = JOptionPane.showInputDialog(frame, "Enter New Product Price in ₹:");
    ...
    private void loadDummyProducts() {
        products.add(new Product(1, "Laptop", 75700));      
        products.add(new Product(2, "Smartphone", 45500));  
        products.add(new Product(3, "Headphones", 3000));   
        products.add(new Product(4, "Watch", 5500));        
        products.add(new Product(5, "Backpack", 2500));     
    }
